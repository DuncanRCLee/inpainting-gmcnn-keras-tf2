...
from tensorflow.keras.layers import Conv2D, Dense, Flatten, LeakyReLU, Multiply
...
class LocalDiscriminator(BaseModel):
    def __init__(self, img_height, img_width, num_channels, output_paths):
        super(LocalDiscriminator, self).__init__(img_height, img_width, num_channels, output_paths, model_name='local_discriminator')
...
class GlobalDiscriminator(BaseModel):
    def __init__(self, img_height, img_width, num_channels, output_paths):
        super(GlobalDiscriminator, self).__init__(img_height, img_width, num_channels, output_paths, model_name='global_discriminator')
