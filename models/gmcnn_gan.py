...
class GMCNNGan(WassersteinGAN):
    ...
    def __init__(self, batch_size, img_height, img_width, num_channels, warm_up_generator,
        ...
        self.generator_optimizer = Adam(learning_rate=self.learning_rate, beta_1=0.5, beta_2=0.9)
        self.discriminator_optimizer = Adam(learning_rate=self.learning_rate, beta_1=0.5, beta_2=0.9)
