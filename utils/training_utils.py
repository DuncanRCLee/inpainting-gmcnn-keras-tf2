...
import cv2
import numpy as np
import logging  # Import the standard Python logging module instead of tf.logging
...
def get_logger():
    log = logging.getLogger(__name__)  # Use the standard Python logging.getLogger() function
